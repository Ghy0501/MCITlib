...
To facilitate further development on top of our codebase, we provide a quick-start guide on how to train a customized [VideoLLaMA2](https://github.com/DAMO-NLP-SG/VideoLLaMA2) with [VideoLLaVA](https://github.com/PKU-YuanGroup/VideoLLaMA2) dataset and evaluate the trained model on the mainstream video-llm benchmarks.
...
* [**Video-ChatGPT**](https://github.com/mbzuai-oryx/Video-ChatGPT), [**VideoLLaMA2**](https://github.com/PKU-YuanGroup/VideoLLaMA2). 
