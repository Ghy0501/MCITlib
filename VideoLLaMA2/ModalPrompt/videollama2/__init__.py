...
def model_init(model_path=None, model_base=None, prefix_len=None, cur_task=None, text_tower=None, num_tasks=None, **kwargs):
    model_path = "DAMO-NLP-SG/VideoLLaMA2-7B" if model_path is None else model_path
    model_name = get_model_name_from_path(model_path)
    tokenizer, model, processor, context_len = load_pretrained_model(model_path, model_base, model_name, prefix_len, cur_task, text_tower, num_tasks, **kwargs)
