...
import sys
sys.path.append('/your_path/MCITlib_v3/VideoLLaMA2/DISCO')
import re
import os
import copy
import json
...
def train(attn_implementation=None):
    ...
    rank0_print(f"\n  Trainable params : {total_trainable:,}  ({total_trainable / 1e6:.2f} M)")
    rank0_print(f"  All params       : {total_all:,}  ({total_all / 1e6:.2f} M)")
    rank0_print(f"  Trainable ratio  : {100 * total_trainable / total_all:.4f} %")
    rank0_print("==========================================\n")
