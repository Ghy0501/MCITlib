...
import sys
sys.path.append('/your_path/MCITlib_v3/VideoLLaMA2/OLoRA')
import re
import os
import copy
import json
...
def train(attn_implementation=None):
    ...
    if training_args.gradient_checkpointing:
        # Prefer non-reentrant checkpointing to avoid DeepSpeed/ZeRO double-backward/parameter-ready issues.
        try:
            model.gradient_checkpointing_enable(gradient_checkpointing_kwargs={"use_reentrant": False})
        except TypeError:
            # Older HF versions / different signatures
