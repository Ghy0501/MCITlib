...
get_task_config() {
    if [ "$TASK_ID" == "1" ]; then
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task1.json"
    elif [ "$TASK_ID" == "2" ]; then
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task2.json"
    elif [ "$TASK_ID" == "3" ]; then
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task3.json"
    elif [ "$TASK_ID" == "4" ]; then
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task4.json"
    elif [ "$TASK_ID" == "5" ]; then
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task5.json"
    elif [ "$TASK_ID" == "6" ]; then
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task6.json"
    elif [ "$TASK_ID" == "7" ]; then
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task7.json"
    else
        echo "$HARD_PATH/configs/train_configs/MoELoRA/Video-LLaVA/CL-VISTA/eval/task8.json"
    fi
}
