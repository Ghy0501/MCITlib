...
def load_pretrained_model(model_path, model_base, model_name, mm_pretrain=None, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", **kwargs):
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            ## 加载预训练对齐模块
            if mm_pretrain is not None:
                mm_projector_weights = torch.load(mm_pretrain, map_location='cpu')
