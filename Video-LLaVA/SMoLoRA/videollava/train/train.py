...
# Borrowed from CoIN.peft.utils.get_peft_model_state_dict
...
def train():
    ...
    if training_args.bits in [4, 8]:
        from CoIN.peft import prepare_model_for_kbit_training
    ...
    if training_args.bits in [4, 8]:
        from CoIN.peft.tuners.lora import LoraLayer
        for name, module in model.named_modules():
