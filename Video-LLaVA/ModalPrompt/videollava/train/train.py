...
import sys
sys.path.append('/your_path/MCITlib_v3/Video-LLaVA/ModalPrompt')
import os
import copy
import random
...
class ModelArguments:
    ...
    num_tasks: Optional[int] = field(default=6)
    transfer_num: Optional[int] = field(default=1)
...
def load_model_from_previous_task(model, previous_task_model_path, training_args):
    ...
    model.base_model.load_state_dict(non_lora_trainables, strict=False)
