...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        image_guide_features_mean = clip_video_features.mean(dim=0, keepdim=True)
        ...
        cos_sim = 0.5 * cos_sim_text[:self.expert_num] + 0.5 * cos_sim_img[:self.expert_num] # 0.5 * cos_sim_text + 0.5 * cos_sim_img
