import sys
sys.path.append('/your_path/MCITlib_v3/Video-LLaVA/DISCO')
import math
import os
import argparse
import json
...
def run_inference(args):
    ...
    tokenizer, model, processor, context_len = load_pretrained_model(args.model_path, args.model_base, model_name, num_task=args.num_task, text_tower=args.text_tower)
