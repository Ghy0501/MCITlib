...
import sys
sys.path.append('/your_path/MCITlib_v3/InternVL/CL-MoE')
import os
import copy
...
from CLMoE.peft import PeftModel, TaskType, get_peft_model, CLMoEMOELoraConfig
...
def train(attn_implementation=None):
    ...
    with open("/your_path/MCITlib_v3/InternVL/CL-MoE/task.txt", "w") as t:
    ...
    if training_args.dora_enable:
        from CLMoE.peft import DoraConfig, get_peft_model
        kwargs = { 
