    ...
    def process_result(self, results_dir):
        ...
        for eval_type, task_name_list in eval_type_dict.items():
            ...
            for task_name in task_name_list:
                ...
                task_txt = os.path.join(results_dir, "merge", task_name + ".txt")
            ...
            output_filename = os.path.join(results_dir, "result.txt")
            with open(output_filename, 'a', encoding='utf-8') as f:
                f.write(f"total score: {scores}\n\n") 

                for task_name, score in task_score_dict.items():
                    f.write(f"\t{task_name} score: {score}\n")
