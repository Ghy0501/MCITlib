...
import sys
sys.path.append('/your_path/MCITlib_v3/InternVL/KeepLoRA')
import os
import copy
...
def find_all_linear_names(model):
    ...
    exclude_names = {'lm_head', '0', '2'}
    lora_module_names -= exclude_names

    print("LoRA target modules:", lora_module_names)
