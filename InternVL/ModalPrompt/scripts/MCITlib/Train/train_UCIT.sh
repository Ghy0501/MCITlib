...
bash scripts/MCITlib/Train/Task1.sh \
    ...
    $HARD_PATH/configs/train_configs/ModalPrompt/InternVL/UCIT/train/task1.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/ModalPrompt/InternVL/UCIT/train/task2.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/ModalPrompt/InternVL/UCIT/train/task3.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/ModalPrompt/InternVL/UCIT/train/task4.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/ModalPrompt/InternVL/UCIT/train/task5.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/ModalPrompt/InternVL/UCIT/train/task6.json
