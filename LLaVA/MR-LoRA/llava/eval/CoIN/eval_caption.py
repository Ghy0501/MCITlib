...
def create_coco_type(annotation_file, result_file, output_dir):
    ...
    return output_path, total, question_ids
...
def merge_captions(pred_file, val_file, output_file, question_ids=None, result_json_path=None):
    ...
    merged_data = []
    for idx, pred_item in enumerate(pred_data):
...
if __name__ == "__main__":
    ...
    if args.result_file is not None:
        output_file, total, question_ids = create_coco_type(
