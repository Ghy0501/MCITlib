...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/DISCO/LLaVA/UCIT/train/task3.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/DISCO/LLaVA/UCIT/train/task4.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/DISCO/LLaVA/UCIT/train/task5.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/DISCO/LLaVA/UCIT/train/task6.json
